...
Installation of the `r Biocpkg("GenomicDataCommons")` package is
...
The `r Biocpkg("GenomicDataCommons")` can access the significant clinical, demographic, biospecimen, and annotation information contained in the NCI GDC. 
