...
This software is in development and will *likely change in response to user
feedback*. To report bugs or problems, either
...
If this statement results in an error such as `SSL connect error`, see
[the troubleshooting section below](#ssl-connection-errors).
...
connection, the following completes in about 30 seconds.
