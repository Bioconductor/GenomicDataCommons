...
After writing this data.frame to disk, the GDC Data Transfer Tool can be used (from R or from the command-line) to orchestrate high-performance, restartable transfers of all the files in the manifest.
...
### Single (or few small) file(s) download
